  ...
  <section className="relative bg-amber-deep py-4 text-ink md:py-5">
    <div className="container-wide grid grid-cols-2 gap-5 text-center md:grid-cols-4 md:gap-6">
      <div className="flex flex-col items-center gap-1">
        ...
        <p className="font-serif text-lg font-semibold md:text-xl">22+ jaar</p>
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <p className="text-xs uppercase tracking-widest text-ink/85">100% natuurlijk</p>
      </div>
      <div className="flex flex-col items-center gap-1">
        ...
        <p className="text-xs tracking-wide text-ink/85 normal-case">Bekend van RTL4</p>
      </div>
    </div>
  </section>
);
